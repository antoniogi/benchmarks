...
# DFLAGS += -DPRINTALL -DALIGN4 -DUSE_JAGGEMM -DUSE_ESSL -DUSE_CSTDIO_LFS -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -DHPM
 DFLAGS += -DPRINTALL -DUSE_JAGGEMM -DUSE_ESSL -DUSE_CSTDIO_LFS -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -DHPM
